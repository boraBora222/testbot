...
- Owner: Dev
- Dependencies: `front/src/config/service.ts`, `front/src/types/index.ts`, `web/routers/orders.py`, `web/models.py`, `shared/types/enums.py`
- Success Criteria:
...
- Confirm every future dashboard/deals consumer can read data through `orderService` instead of direct page-local fetch logic.
