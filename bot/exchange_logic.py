...
def calculate_order_preview(
    ...
    fee_amount = gross_receive_amount * settings.default_fee_percent / Decimal("100")
    receive_amount = gross_receive_amount - fee_amount
    return {
        "rate": _quantize(rate, "0.00000001"),
        "gross_receive_amount": _quantize(gross_receive_amount, "0.01"),
        "fee_amount": _quantize(fee_amount, "0.01"),
        "receive_amount": _quantize(receive_amount, "0.01"),
    }
